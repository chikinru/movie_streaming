  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: ListView.separated(
          ...
          return GestureDetector(
            onTap: () async {
              animeController.animeID.value =
                  animeController.animeNextSeason.value[0].anime[index].malId;
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                image: NetworkImage(
                  animeController
                      .animeNextSeason.value[0].anime[index].imageUrl,
                ),
                fit: BoxFit.cover,
              )),
              child: Padding(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          ...
                          animeController
                              .animeNextSeason.value[0].anime[index].title,
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              animeController
                                  .animeNextSeason.value[0].anime[index].score
                                  .toString(),
                              style: GoogleFonts.questrial(
                                color: Colors.white,
                                fontSize: 10,
        ...
        itemCount: animeController.animeNextSeason.value[0].anime.length,
